/* Dependency-free MD5 (RFC 1321) + Web Crypto helpers for the hash generator. */
...
function toBlocks(input: string): Int32Array {
...
export async function webHash(algo: "SHA-1" | "SHA-256" | "SHA-512", text: string) {
